...
export enum Vendors {
    ...
    ImproveDigital = 253,
    IndexExchangeInc = 10,
    Infogram = 'bn-infogram',
    Instagram = 'bn-instagram',
    IPONWEB = 129,
...
export enum Purposes {
    ...
    GeoLocationInformationForAdTargeting = 'geo_ads',
...
export const DEFAULT_USER_CONSENT: ContextType = {
    ...
    purposes: {
        ...
        [Purposes.AnalysisAndDevelopment]: undefined,
        ...
        [Purposes.FunctionalCookiesAndTechnologies]: undefined,
        [Purposes.GeoLocationInformationForAdTargeting]: undefined,
        [Purposes.MarketingOnSeparatePlatforms]: undefined,
        [Purposes.MeasureAdPerformance]: undefined,
        [Purposes.MeasureContentPerformance]: undefined,
        [Purposes.NecessaryCookies]: undefined,
        [Purposes.ProfilingAndPersonalisedAds]: undefined,
