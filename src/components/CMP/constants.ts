...
export enum Vendors {
    ...
    ImproveDigital = 253,
    IndexExchangeInc = 10,
    Infogram = 'c:bn-infogram',
    Instagram = 'c:bn-instagram',
    IPONWEB = 129,
    KantarMediaSwedenAB = 'c:kantarsif-QJr886kb',
    Keesing = 'c:bn-keesing',
    ...
    RTBHouse = 16,
    SeenthisAB = 415,
    ShootItLive = 'c:bn-shootitlive',
    ShowheroesSE = 111,
    SmartAdserver = 45,
    Spotify = 'c:bn-spotify',
    ...
    Datawrapper = 'c:bn-datawrapper',
    Flowplayer = 'c:bn-flowplayer',
    Ifragasatt = 'c:bn-ifragasatt',
    Podspace = 'c:podspace-4ExEPKcQ',
    Libsyn = 'c:bn-libsyn',
    Wufoo = 'c:bn-wufoo',
    GoogleForms = 'c:googlefor-M4AiyDM2',
    GoogleMaps = 'c:bn-googlemaps',
